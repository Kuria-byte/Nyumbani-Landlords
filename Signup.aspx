<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Signup.aspx.cs" Inherits="Nyumbani_Landlords.Signup" %>
...
<head runat="server">
    ...
    <!-- Page Title  -->
    <title>Registration | Nyumbani</title>
    <!-- StyleSheets  -->
                            ...
                            <div class="nk-block nk-block-middle nk-auth-body">
                                ...
                                <div class="nk-block-head">
                                    <div class="nk-block-head-content">
                                        ...
                                        <div class="nk-block-des">
                                            <p>Create New Landlord Account</p>
                                        </div>
                                    </div>
                                </div>
                                <%--  Alerts--%>
                                <div class="example-alert" id="SuccessMsg" visible="false" runat="server">
                                    <div class="alert alert-fill alert-success alert-icon">
                                        <em class="icon ni ni-check-circle"></em><strong>Welcome</strong>. Your accoun has been registered successfully.
                                    </div>
                                </div>
                                ...
                                <form id="form1" action="#" method="post" runat="server">
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="txtName" class="form-control form-control-lg" placeholder="Full name" ValidationGroup="signup" runat="server"></asp:TextBox>
                                    </div>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" Display="Dynamic" runat="server" ErrorMessage="Please enter name"
                                        ControlToValidate="txtName" ValidationGroup="signup" SetFocusOnError="true" ForeColor="red"></asp:RequiredFieldValidator>
                                    ...
                                    <div class="form-group">
                                        <asp:Button type="submit" ID="btnSubmit" class="btn btn-lg btn-primary btn-block" runat="server" ValidationGroup="signup" Text="Register" OnClick="btnSubmit_Click" />
                                    </div>
                                </form>
                                <!-- form -->
                                <div class="form-note-s2 pt-4">
                                    Already have an account ? <a href="Login.aspx"><strong>Sign in instead</strong></a>
                                </div>
